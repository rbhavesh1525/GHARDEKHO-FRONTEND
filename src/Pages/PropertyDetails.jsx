...
import { ChatPage } from "./PageIndex";
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <div className="flex justify-between items-start">
                <div>
                  <Badge className="bg-blue-900 text-white">{property.bhk}</Badge>
            ...
            <motion.div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <PropertyMap location={property.location} city={property.location} />
            </motion.div>
...
>
  ...
  onSend={(message) => {
    ...
    // later you will fire API — property.id, owner, user, message
  }}
/>
    </div>
  );
